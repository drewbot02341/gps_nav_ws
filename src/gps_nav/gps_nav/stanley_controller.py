...
class VehicleController(Node):
    ...
    def main_timer_callback(self):
        ...
        if self.have_goal_pose and self.have_vehicle_pose:
            ...
            error_cross_track, error_heading_rad, line_pt = get_cross_track_and_heading_error(
                self.closest_point,
            ...
            out_msg.drive.steering_angle = error_heading_rad + math.atan(self.K * error_cross_track / (self.speed + 0.0001))
